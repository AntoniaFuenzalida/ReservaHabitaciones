  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light"> 
    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            ...
            <div class="alert" style="margin-top: 2%" v-if="this.error == true">
                <span class="closebtn" @click="reiniciar()">&times;</span>
                {{ this.mensaje }}
            </div>
        </div>
    </header>
      ...
      window.history.back();
        ...
        async reservaFiltradas() {
            ...
            if (this.fecha_fin == null || this.fecha_inicio == null) {
                ...
                this.mensaje =
                    "Error: ingrese correctamente los parametros en ambos campos de fechas";
                this.error = true;
                this.nulos = true;
            } else {
                this.nulos = false;
            ...
            if (
                ...
                if (this.nulos == false) {
                    ...
                    this.mensaje =
                        "Error: ingrese un rango fechas dentro del el rango valido";
                    this.error = true;
                    this.final = [];
                }
            }
            ...
            if (
                ...
                if (this.fecha_fin != null && this.fecha_inicio != null) {
                    ...
                    resultreservas.forEach((reserva) => {
                        if (reserva.data().estadoReserva != "Cancelada") {
                    ...
                    if (Number(this.adultos) > 0) {
                        let tamanno =
                            Number(this.adultos) + Number(this.kid) / 2;
                        result.forEach((doc) => {
                            if (
                                HabitacionesOcupadas.includes(doc.data().numero)
                            ) {
                                console.log();
                            } else if (
                        ...
                        this.mensaje =
                            "Error: no cumple con la cantidad minima de adultos";
                        this.error = true;
