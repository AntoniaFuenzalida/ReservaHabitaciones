    ...
    methods: {
        ...
        async datosCorrectos(rep) {
            ...
            if (!Number(this.cantidadCamas) && this.cantidadCamas != "0") {
                correcto = 0;
                console.log(
                    "La cantidad de camas de la habitacion debe ser un numero"
                );
            } else if (this.cantidadCamas < 1) {
                correcto = 0;
                console.log(
                    "La cantidad de camas de la habitacion debe ser positiva"
                );
            }
            return correcto;
        },
...
<template>
    ...
    <div class="row" style="margin-top: 3%">
        ...
        <div class="col-lg-8">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card mb-6" style="margin-left: 12%"></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col">
            ...
            >
                <button
                    ...
                    class="btn btn-dark"
                    data-bs-toggle="modal"
                    data-bs-target="#ModificarHabitacion"
                >
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="container">
                        <div class="row">
                            <select
                                v-model="seleccionado.numero"
                                class="form-control"
                                id="habitacionesSelector"
                            >
                                <option>seleccionar habitacion</option>
                                <option
                                    v-for="numero in numHabitacion"
                                    :key="numero"
                                >
                                    {{ numero.numero }}
                                </option>
                ...
                <div class="modal-footer">
                    ...
                    <button
                        type="button"
                        class="btn btn-dark"
                        @click="modificarDatos(seleccionado.numero)"
                    >
                        Guardar
                    </button>
                </div>
