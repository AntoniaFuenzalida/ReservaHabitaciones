                ...
                <div class="modal-body">
                    <ul class="list-group">
                        <li class="list-group-item">
                            <img src="/verde.ico" />Reserva lista
                        </li>
                        <li class="list-group-item">
                            <img src="/amarillo.ico" />Reserva por confirmar
                        </li>
                        <li class="list-group-item">
                            <img src="/rojo.ico" />Reserva cancelada
                        </li>
                        <li class="list-group-item">
                            <img src="/azul.ico" />Reserva utilizada
                        </li>
                        <li class="list-group-item">
                            <img src="/trash.ico" />Cancelar/Eliminar Reserva
                        </li>
                    </ul>
                </div>
