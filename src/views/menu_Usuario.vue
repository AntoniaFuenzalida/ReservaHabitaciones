                ...
                <div class="col mb-3">
                    <div class="card h-60">
                        ...
                        <img class="card-img-top" style="
                                ...
                                width: 200px;
                                margin-left: 10%;
                            " src="iconsketchbook.png" alt="..." />
                        <!-- Product details-->
                        <div class="card-body p-4">
                            <div class="text-center">
                                <!-- Product name-->
                                <div class="text-center">
                                    <a class="btn btn-dark mt-auto" onclick="location.href='/Reservar_Vista';">Has tu
                                        Reserva</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col mb-3">
                    <div class="card h-60">
                        ...
                        <img class="card-img-top" style="
                                ...
                                width: 200px;
                                margin-left: 10%;
                            " src="icondiscount.png" alt="..." />
                        <!-- Product details-->
                        <div class="card-body p-4">
                            <div class="text-center">
                                <!-- Product name-->
                                <div class="text-center">
                                    <a class="btn btn-dark mt-auto" href="./tus_Promociones">Promociones</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card h-60">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center">
                                <!-- Product name-->
                                <div class="text-center">
                                    <a class="btn btn-dark mt-auto" href="./Consulta_Vistas">Tus Reservas</a>
                                </div>
                            </div>
                        </div>
                    </div>
